...
import burp.pkey.common.config.ConfigManager;
...
import burp.pkey.onescan.ui.widget.payloadlist.SimplePayloadList;
...
public class Config {
    ...
    public static final String KEY_ENABLE_PAYLOAD_MULTI_BYPASS = "payload-bypass";
    public static final String KEY_ENABLE_PAYLOAD_SINGLE_BYPASS = "payload-403bypass";
    // 配置常量值
    ...
    public static void init(IBurpExtenderCallbacks wordDir) {
        mCallbacks = wordDir;
        KEY_COLLECT_PATH = getWorkDir() + "collect";
        KEY_WORDLIST_PATH = getWorkDir() + "wordlist";
        sWorkDir = null;
    ...
    public static String getWorkDir() {
        String workDir = Paths.get(mCallbacks.getExtensionFilename())
                .getParent().toString() + File.separator + ".config" + File.separator + "PKScan" + File.separator;
