...
public class CollectManager {
    ...
    private static final Class<?>[] sModules = {
            FullPathCollect.class,
            WebNameCollect.class,
            FileNameCollect.class,
            JsonFieldCollect.class,
            UrlParamCollect.class,
            PostParamCollect.class,
            ParamValueCollect.class
    };
